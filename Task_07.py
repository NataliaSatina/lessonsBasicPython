...
for titles_id in titles.items():
    sum_quantity,sum_price=0,0
    for n_sales in sales[titles_id[1]]:
        sum_quantity = sum_quantity + (n_sales['quantity'])
        sum_price = sum_price + n_sales['price']
    print("Товар " + titles_id[0] + " - " + str(sum_quantity) + " шт, стоимость " + str(sum_price))
